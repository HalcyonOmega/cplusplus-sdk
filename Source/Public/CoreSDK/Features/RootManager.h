...
class RootManager {
  public:
     ...
     * root.
     */
    Root AddRoot(const Root& InRoot);
     ...
     */
    Root AddRoot(const MCP::URIFile& InURI,
                 const std::optional<std::string>& InName = std::nullopt);
     ...
     */
    void RemoveRoot(const MCP::URIFile& InURI);
     ...
     */
    static Root CreateRoot(const MCP::URIFile& InURI,
                           const std::optional<std::string>& InName = std::nullopt);
