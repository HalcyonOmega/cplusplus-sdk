...
public:
  explicit ToolError(const std::string &InMessage)
...
public:
  using ToolFunction =
      std::function<CallToolResponse::Result(const JSONData &, MCPContext *)>;
  ...
  ListTools(const PaginatedRequestParams &InRequest) const;
