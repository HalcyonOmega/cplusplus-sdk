...
// struct Result {
//     optional<ResultMeta> _meta; // This result property is reserved by the protocol to allow
//     clients
//                                 // and servers to attach additional metadata to their responses.
//     Passthrough Additional;     // Additional properties.

//     Result Empty() {
//         return Result{_meta: nullopt, Additional: {}};
//     }
// };
...
//     optional<string>
//         Instructions; // Instructions describing how to use the server and its features. This can
//         be
...
//     optional<Cursor>
//         NextCursor; // An opaque token representing the pagination position after the last
//         returned
...
//                            // output, this field MUST be present in the result, and contain a
//                            JSON
